...
import com.example.txim.activity.AddMoreActivity;
import com.example.txim.adapter.NewFriendListAdapter;
    ...
    private void initPendency() {
        ...
        TIMFriendshipManager.getInstance().getPendencyList(timFriendPendencyRequest, new TIMValueCallBack<TIMFriendPendencyResponse>() {
            ...
            public void onSuccess(TIMFriendPendencyResponse timFriendPendencyResponse) {
                ...
                mAdapter = new NewFriendListAdapter(NewFriend.this, R.layout.contact_selecable_adapter_item, mList);
